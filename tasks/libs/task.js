    ...
    htmlSourcesFiles(fileName, isAll=false){
        ...
        if(all){
            if(arguments.length>1 && arguments[0]){
                return [path.normalize(this.Config.HTML_SOURCE_PATH+ "/"+fileName+"/**/*.html"), notIncludeHtml]
            }else{
                return [path.normalize(this.Config.HTML_SOURCE_PATH+"/**/*.html"),notIncludeHtml]
            }
            ...
            return this.Config.HTML_SOURCE_PATH + path.sep + path.normalize(fileName)
        }
    }
