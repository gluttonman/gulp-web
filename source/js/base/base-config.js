 ...
 */
var support_extension = ["avi","mp4","mpg","mpeg","wmv","asf","flv","rm","rmvb","3gp","mov","mkv","vob","f4v"];
function dealPreviewFun_old(file_info){
	...
	var m3u8_status = file_info.m3u8_status;//2016-3-3-add	
	...
	if(m3u8_status != 0 && check_extension != "-1"){
		if(p_type == 1){
			_class = "fancybox fancybox.iframe";
			_href = url_path_html + "/html/ypt/common/preview_video.html?file_id="+file_id+"&p_type="+p_type+"&r_format="+file_ext+"&resource_title="+Base64.encode(file_info.file_title)+"&preview_status="+file_info.p_status+"&m3u8_status="+m3u8_status;
		}else{
			_href = url_path_html + "/html/ypt/common/preview_video.html?file_id="+file_id+"&title="+Base64.encode(_title)+"&p_type="+p_type+"&r_format="+file_ext+"&resource_title="+Base64.encode(file_info.file_title)+"&preview_status="+file_info.p_status+"&m3u8_status="+m3u8_status;
		} 
	}else{
		if(file_ext == "jpg" || file_ext == "jpeg" || file_ext == "png" || file_ext == "gif" || file_ext == "bmp"){
			...
			if(p_type == 1){
				_class = "fancybox fancybox.iframe";
				_href = url_path_html + "/html/ypt/common/preview_flv.html?file_path="+path_m+"&file_id="+file_id+"&p_type="+p_type;
			}else{
				_href = url_path_html + "/html/ypt/common/preview_flv.html?file_path="+path_m+"&file_id="+file_id+"&title="+Base64.encode(_title)+"&p_type="+p_type;
			}
		}else{
			//需要判断预览状态2015-12-29添加对生成预览失败的判断
			if(file_info.p_status != "1"){
				...
				switch(file_ext) 
				{
					...
					case "rmvb":
						...
						if(p_type == 1){
							_class = "fancybox fancybox.iframe";
							_href = url_path_html + "/html/ypt/common/preview_flv.html?file_path="+path_p+"&file_id="+file_id+"&p_type="+p_type;
						}else{
							_href = url_path_html + "/html/ypt/common/preview_flv.html?file_path="+path_p+"&file_id="+file_id+"&title="+Base64.encode(_title)+"&p_type="+p_type;
						}
						break;	
					default:
						if(p_type == 1){
...
function dealPreviewFun(file_info){
	...
	if(m3u8_status != 0 && check_extension != "-1"){
		if(p_type == 1){
			...
			_href = url_path_html + "/html/ypt/common_tq/resourcebk_play.html?content=preview_video.html&file_id="+file_id+"&title="+Base64.encode(_title)+"&p_type="+p_type+"&r_format="+file_ext+"&resource_title="+Base64.encode(file_info.file_title)+"&preview_status="+file_info.p_status+"&m3u8_status="+m3u8_status;
		} 
	}else{
		if(file_ext == "jpg" || file_ext == "jpeg" || file_ext == "png" || file_ext == "gif" || file_ext == "bmp"){
			//不需要判断预览状态
			...
			if(p_type == 1){
				...
				_href = url_path_html + "/html/ypt/common_tq/resourcebk_play.html?content=preview_image.html&file_path="+_p+"&title="+Base64.encode(_title)+"&width="+_w+"&height="+_h+"&file_id="+file_id;
			}
		}else if(file_ext == "xmind"){
			if(p_type == 1){
				_class = "fancybox";
			...
			if(p_type == 1){
				...
				//??????????????
				_href = url_path_html + "/html/ypt/common_tq/resourcebk_play.html?content=preview_flash2D_X.html&file_path="+path_m+"&file_id="+file_id+"&width="+_w+"&height="+_h+"&title="+Base64.encode(_title)+"&p_type="+p_type;
			}
		}else if(file_ext == "mp3"){
			//不需要判断预览状态
			if(p_type == 1){
				_class = "fancybox fancybox.iframe";
				_href = url_path_html + "/html/ypt/common_tq/preview_mp3.html?file_path="+path_m+"&file_id="+file_id+"&p_type="+p_type;
			}else{
				_href = url_path_html + "/html/ypt/common_tq/resourcebk_play.html?content=preview_mp3.html?file_path="+path_m+"&file_id="+file_id+"&title="+Base64.encode(_title)+"&p_type="+p_type;
			}
		}else if(file_ext == "flv"){
			_title = _title + "【预览】";
			if(p_type == 1){
				...
				_href = url_path_html + "/html/ypt/common_tq/resourcebk_play.html?content=preview_flv.html&file_path="+path_m+"&file_id="+file_id+"&title="+Base64.encode(_title)+"&p_type="+p_type;
			}
		}else{
			//需要判断预览状态2015-12-29添加对生成预览失败的判断
			if(file_info.p_status != "1"){
				...
				switch(file_ext) 
				{
					...
					case "pdf":
						...
						if(p_type == 1){
							...
							_href = url_path_html + "/html/ypt/common_tq/resourcebk_play.html?content="+url_str+"&file_path="+path_m+"&file_id="+file_id+"&title="+Base64.encode(_title)+"&p_type="+p_type;
						}
						break;
					default:
						if(p_type == 1){
							...
							_href = url_path_html + "/html/ypt/common_tq/resourcebk_play.html?content=res_no_view.html&ile_path="+path_m+"&file_id="+file_id+"&title="+Base64.encode(_title)+"&p_type="+p_type;
						}
				}
			}else{
				//已生成预览
				switch(file_ext) 
				{
					...
					case "pdf":
						if(p_type == 1){
							...
							//??
							_href = url_path_html + "/html/ypt/common_tq/resourcebk_play.html?content=preview_doc.html&file_path="+path_p+"&file_id="+file_id+"&page_num="+file_info.file_page+"&title="+Base64.encode(_title)+"&p_type="+p_type;
						}
						break;
					case "asf":
					case "wmv":
					...
					case "rmvb":
						...
						if(p_type == 1){
							...
							_href = url_path_html + "/html/ypt/common_tq/resourcebk_play.html?content=preview_flv.html&file_path="+path_p+"&file_id="+file_id+"&title="+Base64.encode(_title)+"&p_type="+p_type;
						}
						break;	
					default:
						if(p_type == 1){
							...
							_href = url_path_html + "/html/ypt/common_tq/resourcebk_play.html?content=res_no_view.html&file_path="+path_m+"&file_id="+file_id+"&title="+Base64.encode(_title)+"&p_type="+p_type;
						}
				}
			}
		}
...
function getResInfo(title,resource_type,type_id,resource_id,event){
	...
	//self.parent.tb_show("当前"+str+"："+title,url_path_html + "/ypt/main/show_res_info.html?resource_type="+resource_type+"&type_id="+type_id+"&resource_id="+resource_id+"&TB_iframe=true&height=360&width=540","thickbox");
	self.parent.tb_show("当前"+str+"："+title,"../main/show_res_info.html?resource_type="+resource_type+"&type_id="+type_id+"&resource_id="+resource_id+"&TB_iframe=true&height=400&width=600","thickbox");	
}
...
function createStar(score,max_score,show_score){
	...
	for(var i = 0;i < score_int; i++){
		img_str += '<img class="star" src="../../../images/star/1.png"/>';
		star_count ++;
	}
	if(score_int < max_score && decimal != 0){
		img_str += '<img class="star" src="../../../images/star/0.'+decimal+'.png"/>';
		star_count ++;
	}
	for(var j = max_score;j > star_count; j--){
		img_str += '<img class="star" src="../../../images/star/0.png"/>';
	}
	if(show_score){
